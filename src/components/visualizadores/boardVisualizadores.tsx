...
import { ColumnVisualizadores } from "./columnVisualizadores";
...
import { ChangeOwnerVisualizadores } from "./modalChangeOwnerVisualizadores";
...
export function BoardVisualizadores() {
      ...
      >
        <div className="flex mt-6 bg-white box-border max-w-full h-auto">
          ...
          <ColumnVisualizadores
            ...
            id="3"
          />
          <ColumnVisualizadores title="Teste" tasks={teste} id="4" />
          <ColumnVisualizadores
