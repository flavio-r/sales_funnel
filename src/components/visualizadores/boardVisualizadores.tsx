   ...
   */
    ...
    return (
        ...
        <DragDropContext useDrag={handleGanhouPerdeu} onDragEnd={handleDragEnd} onDragStart={handleDragStart}>
            ...
            { <ChangeOwnerVisualizadores mostrarModal={isOpen} atualizaEstadoModal={handleChangeModalState} idTask={selectedTaskId} currentOwner={currentOwner} /> }

            <ColumnVisualizadores title="Qualificação" tasks={lead} leads={leadMysql} id="1"/>
            <ColumnVisualizadores title="Agendamento / Reunião" tasks={contato} id="2"/>
            <ColumnVisualizadores title="Diagnóstico" tasks={diagnostico} id="3"/>
            <ColumnVisualizadores title="Teste" tasks={teste} id="4"/>
            <ColumnVisualizadores title="Proposta de Valor" tasks={negociacao} id="5"/>
