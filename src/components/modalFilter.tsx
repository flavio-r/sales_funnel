  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-6 mt-4">
        <p className="m-0 self-start text-xl font-semibold mb-1">
          Data prevista de avanço de etapa
        </p>
        <div className="flex justify-between gap-4 w-full  h-full">
          <div className="w-52">
            <InputDados
              preValue={baseFilters.dataInicio}
              tirarTopo={true}
              editable={true}
      ...
      <div className=" flex flex-col  items-center mb-6">
        ...
        <div className="flex justify-between h-full w-full gap-4">
          <div className=" w-52 ">
            <InputDados
              tirarTopo={true}
              preValue={baseFilters.valorMinimo}
              editable={true}
          ...
          <div className="w-52">
            <InputDados
              tirarTopo={true}
              preValue={baseFilters.valorMaximo}
              editable={true}
      ...
      <div className="w-full flex flex-col  items-center mb-4">
        <SelectDados
          customCss="w-full"
          tipo="municipios"
          preValue={baseFilters.municipio}
      ...
      <div className="w-full flex flex-col  items-center mb-4">
        <SelectDados
          customCss="w-full"
          tipo="heatLevels"
          preValue={baseFilters.interesse}
          municipios={municipios}
      ...
      <div className=" flex flex-col  items-center mb-8">
        <div className="self-start">
          <p className=" m-0 mb-2 bg-white font-semibold text-xl ">
            Apenas Destacados
          </p>
      ...
      <div className=" flex flex-col  items-center mb-8">
        <div className="self-start">
          <p className=" m-0 mb-2 bg-white font-semibold text-xl ">
            Oportunidades com tickets para mim
          </p>
          <label className="toggle-switch">
            <input
              type="checkbox"
              onClick={() => setSwitch2Handler(!switch2Handler)}
            />
            <div className="toggle-switch-background">
              <div className="toggle-switch-handle"></div>
            </div>
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className=" hover:scale-105 h-10 w-28 customRedBorder outline-none bg-white rounded-md font-semibold text-red-500 cursor-pointer hover:bg-red-500 hover:text-white transition-all duration-300 mt-4 "
        >
          Limpar Filtros
        </button>
        <GrnBtn
          form="filterOp"
          nomeBtn="Aplicar Filtros"
          type="submit"
          icon={<IoFilterSharp />}
          customCss="w-48 self-end mt-4"
        />
      </div>
    </form>
  );
