    ...
    <div className={`relative ${tirarTopo ? "" : "mt-4"} `}>
      ...
      <div className="flex items-center">
        <input
          ...
          {...register(name, {
            value: formattedPreValue ? formattedPreValue : "",
            onChange: (e) => handleInputChange(e),
          })}
          type={type ? type : "text"}
          placeholder={insidePlaceholder ? insidePlaceholder : ""}
          className={` ${customCss} ${
            isChanged ? "bordaSelecionado" : ""
          } corPlaceholder customBorderInput transition-all duration-500  text-black fontePadrao font-semibold w-full h-10 rounded-md text-lg ${
            icon ? "pl-9" : "pr-6 pl-2"
