      ...
      <div className=" px-8 h-5/12 bg-custom-gray py-12 shadow-lg rounded-md flex flex-col items-center border   ">
        ...
        >
          ...
          <button
            ...
            className={`h-12 w-full rounded-md border-none bg-green-500 text-white font-semibold text-lg mt-6 cursor-pointer hover:bg-green-600 transition-all duration-300 shadow-md hover:shadow-lg flex gap-4 items-center justify-center ${
              loginLoading ? "disabled:opacity-75 cursor-default" : ""
            } `}
          >
          ...
          <p className=" text-red-600 m-0 font-semibold mt-2 ">
            {" "}
            {loginErrors}
          </p>
        </form>
        <a
          href=""
          className=" no-underline text-black hover:text-blue-600 transition-all duration-300 mt-6"
          onClick={(e) => handleNoAccess(e)}
        >
          Não tenho acesso
        </a>
        <Toaster />
